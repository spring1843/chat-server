...
func registerAllEndpoints(chatServer *chat.Service, container *restful.Container) {
...
func NewRESTfulAPI(config config.Config, chatServer *chat.Service) *http.Server {
