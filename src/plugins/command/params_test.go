...
func TestParseCommandFromInput(t *testing.T) {
...
func TestParseChannelFromInput(t *testing.T) {
...
func TestParseNickNameFomInput(t *testing.T) {
...
func TestParseMessageFromInput(t *testing.T) {
